<link rel="stylesheet" class="aplayer-secondary-style-marker" href="\nemo-space\assets\css\APlayer.min.css"><script src="\nemo-space\assets\js\APlayer.min.js" class="aplayer-secondary-script-marker"></script>
/******/
      ...
      var render = function render(res) {
        ...
        for (var j = 0, len2 = res.list.length; j < len2; j++) {
          ...
          for (var i = 0, len = data.link.length; i < len; i++) {
            var minSrc = 'https://raw.githubusercontent.com/nemo158/blog_photo/master/min_photos/' + data.link[i];
            var src = 'https://raw.githubusercontent.com/nemo158/blog_photo/master/photos/' + data.link[i];
